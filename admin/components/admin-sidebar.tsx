...
const FALLBACK_NAV: MenuRow[] = [
  ...
  { id: "fb-ai-seo", key: "sidebar.aiSeoInsights", label: "", path: "/admin/ai-seo-insights", icon: "Sparkles", permission: "", visible: true, order: 2 },
  { id: "fb-tools", key: "sidebar.tools", label: "", path: "/admin/tools", icon: "Wrench", permission: "", visible: true, order: 3 },
  { id: "fb-users", key: "sidebar.users", label: "", path: "/admin/users", icon: "Users", permission: "", visible: true, order: 4 },
  { id: "fb-reviews", key: "sidebar.reviews", label: "", path: "/admin/reviews", icon: "MessageSquare", permission: "", visible: true, order: 5 },
  { id: "fb-money", key: "sidebar.monetization", label: "", path: "/admin/monetization", icon: "DollarSign", permission: "", visible: true, order: 6 },
  { id: "fb-seo", key: "sidebar.pageSeo", label: "", path: "/admin/page-seo", icon: "Search", permission: "", visible: true, order: 7 },
  { id: "fb-tool-jsonld", key: "sidebar.toolJsonLd", label: "", path: "/admin/tool-json-ld", icon: "Braces", permission: "", visible: true, order: 13 },
  { id: "fb-blocks", key: "sidebar.siteBlocks", label: "", path: "/admin/site-blocks", icon: "Code2", permission: "", visible: true, order: 8 },
  { id: "fb-search-sugg", key: "sidebar.searchSuggestions", label: "", path: "/admin/search-suggestions", icon: "ListOrdered", permission: "", visible: true, order: 9 },
  { id: "fb-site-submit", key: "sidebar.siteSubmitForm", label: "", path: "/admin/site-submit", icon: "ClipboardList", permission: "", visible: true, order: 10 },
  { id: "fb-site-dashboard", key: "sidebar.siteDashboardForm", label: "", path: "/admin/site-dashboard", icon: "LayoutTemplate", permission: "", visible: true, order: 11 },
  { id: "fb-crawler", key: "sidebar.crawlerData", label: "", path: "/admin/crawler", icon: "CloudDownload", permission: "", visible: true, order: 12 },
...
export function AdminSidebar() {
  ...
  return (
    <aside className="w-56 shrink-0 border-r border-admin-border/80 bg-admin-surface/95 backdrop-blur">
      <div className="p-4 border-b border-white/[0.06]">
        <p className="text-xs uppercase tracking-wider text-admin-accent">{t("sidebar.brandAdmin")}</p>
          ...
          return (
            <Link
              ...
              className={clsx(
                ...
                active ? "bg-admin-highlight text-white" : "text-gray-400 hover:bg-white/5 hover:text-gray-200"
              )}
            >
